...
temperature_1995 = temperatures[0][2]
temperature_2010 = temperatures[1][2]
temperature_2020 = temperatures[2][2]

def equal_average_temperatures(temperature: list) -> int:
    temp_set = set()
    for temp in temperature:
        temp_set.add(temp)
    print(f"Set: {temp_set}")
    return 31 - len(temp_set)

print(equal_average_temperatures(temperature_2020))

# Criteria:

# Implement a program that, given this data, prints the answers for the following questions (each separate line):
